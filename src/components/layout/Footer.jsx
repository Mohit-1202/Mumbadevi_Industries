            ...
            <div className="max-w-7xl mx-auto relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-16 lg:gap-24 mb-20 text-center lg:text-left">
                    <div className="lg:col-span-2">
                        ...
                        <p className="text-slate-600 dark:text-white/70 font-medium max-w-md mx-auto lg:mx-0 mb-12 leading-relaxed text-lg lg:text-xl italic">
                            ...
                            <span className="text-slate-400 dark:text-white/40 not-italic font-normal text-base block mt-2">Your premium partner in high-precision offset printing.</span>
                        </p>
                        <div className="flex justify-center lg:justify-start gap-4">
                            {['LN', 'TW', 'IG', 'FB'].map(social => (
                                <a key={social} href="#" className="w-12 h-12 lg:w-14 lg:h-14 bg-slate-200/50 dark:bg-white/5 border border-slate-300 dark:border-white/10 rounded-2xl flex items-center justify-center text-[10px] font-black text-slate-600 dark:text-white hover:bg-primary hover:border-primary hover:text-white hover:scale-110 shadow-lg transition-all duration-300">
                                    {social}
                                </a>
                            ))}
                        </div>
                    ...
                    <div className="flex flex-col items-center lg:items-start">
                        ...
                        <ul className="space-y-6 text-base font-bold text-slate-500 dark:text-white/60">
                            <li><a href="#home" className="hover:text-primary dark:hover:text-white transition-all hover:translate-x-2 inline-block duration-300">Home</a></li>
                            <li><a href="#about" className="hover:text-primary dark:hover:text-white transition-all hover:translate-x-2 inline-block duration-300">About Us</a></li>
                            <li><a href="#products" className="hover:text-primary dark:hover:text-white transition-all hover:translate-x-2 inline-block duration-300">Capabilities</a></li>
                            <li><a href="#infrastructure" className="hover:text-primary dark:hover:text-white transition-all hover:translate-x-2 inline-block duration-300">Infrastructure</a></li>
                        </ul>
                    </div>
                    ...
                    <div className="flex flex-col items-center lg:items-start text-center lg:text-left">
                        ...
                        <div className="text-base font-bold leading-relaxed text-slate-500 dark:text-white/60 mb-12">
                            Mumbadevi Industries,<br />
                            <span className="text-slate-800 dark:text-white/80">Mumbai, Maharashtra,</span><br />
                            India.
                        </div>
                        <button
                            onClick={scrollToTop}
                ...
                <div className="pt-12 border-t border-slate-200 dark:border-white/10 flex flex-col md:flex-row justify-between items-center gap-8 text-[9px] font-black uppercase tracking-[0.3em] text-slate-400 dark:text-white/20">
                    ...
                    <div className="flex gap-10">
                        <a href="#" className="hover:text-primary dark:hover:text-white/60 transition-colors">Privacy Policy</a>
                        <a href="#" className="hover:text-primary dark:hover:text-white/60 transition-colors">Terms of Service</a>
                    </div>
                </div>
            </div>
        </footer>
