...
const AboutUs = () => {
    return (
        <Section id="about">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center min-h-[100svh]">
                <motion.div
                ...
                >
                    ...
                    <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black mb-6 lg:mb-10 text-slate-900 dark:text-white leading-tight font-heading uppercase">
                    ...
                    <div className="flex flex-col sm:flex-row gap-12 mt-12 pt-12 border-t border-slate-100 dark:border-slate-800/50 justify-center lg:justify-start">
                        <div className="group">
