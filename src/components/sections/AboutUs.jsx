            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                ...
                >
                    ...
                    <div className="flex flex-col sm:flex-row gap-8 mt-6 pt-6 border-t border-slate-100 dark:border-slate-800/50 justify-center lg:justify-start">
                        <div className="group">
                            <div className="text-3xl lg:text-4xl font-black text-slate-900 dark:text-white mb-1 group-hover:text-primary transition-colors">Since 2004</div>
                            <div className="text-sm font-bold uppercase tracking-widest text-primary/60">Established Excellence</div>
                        </div>
                        <div className="group">
                            <div className="text-3xl lg:text-4xl font-black text-slate-900 dark:text-white mb-1 group-hover:text-primary transition-colors">ISO</div>
                ...
                <motion.div
                    ...
                    className="relative"
                >
                    <div className="aspect-[4/5] lg:aspect-square lg:max-h-[60vh] rounded-2xl overflow-hidden shadow-2xl relative group border-8 border-white dark:border-slate-800 mx-auto">
                        <img
